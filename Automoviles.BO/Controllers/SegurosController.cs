...
namespace Automoviles.BO.Controllers
{
    public class SegurosController : Controller
    {
        ...
        public SegurosController(AutomovilDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Empresa")] Seguro seguro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Empresa")] Seguro seguro)
        {
            if (id != seguro.Id)
            {
                return NotFound();
